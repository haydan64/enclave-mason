import { regionBounds, regionVolume, Vector } from "./../../library/Minecraft.js";
...
export const selectionModes = ["cuboid", "extend", "sphere", "cylinder"];
const drawFrequency = 8; // in ticks
export class Selection {
    constructor(player) {
        this._mode = "cuboid";
        this._points = [];
        this._visible = config.drawOutlines;
