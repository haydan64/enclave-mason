import { Server, RawText, Vector } from "./../library/Minecraft.js";
...
export function blockHasNBTData(block) {
    const components = ["minecraft:inventory", "minecraft:sign", "minecraft:piston", "minecraft:record_player", "minecraft:fluidContainer"];
    const nbt_blocks = [
        "minecraft:bee_nest",
        "minecraft:beehive",
