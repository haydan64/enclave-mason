...
function setSelection(session, chunks, useHeightLimits) {
    const heights = useHeightLimits ? getWorldHeightLimits(session.getPlayer().dimension) : [chunks[0].y * 16, chunks[1].y * 16 + 15];
